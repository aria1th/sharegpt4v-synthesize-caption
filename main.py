...
- Only describe the elements that are visually represented in the image.

- Describe the details, clothings, and accessories of the depicted characters each in a separate sentence.
...
def bind_inference_api(app: FastAPI):
    ...
    def wrap_inference(args: InferenceArgumentsInput) -> InferenceArgumentsOutput:
        """
        Wrap inference.
        """
